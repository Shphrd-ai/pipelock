...
type AssessSources struct {
	SchemaVersion string                `json:"schema_version"`
	Simulate      *audit.SimulateResult `json:"simulate,omitempty"`
	AuditScore    *audit.ScoreResult    `json:"audit_score,omitempty"`
	VerifyInstall *diag.VerifyReport    `json:"verify_install,omitempty"`
