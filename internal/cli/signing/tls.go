...
import (
	...
	"github.com/Shphrd-ai/pipelock/internal/certgen"
	"github.com/Shphrd-ai/pipelock/internal/cliutil"
)

// TlsCmd returns the "tls" cobra command tree.
...
// TlsInitCmd returns the "tls init" cobra command.
func TlsInitCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			if outDir == "" {
				outDir, err = cliutil.ResolveKeystoreDir("")
				if err != nil {
...
// TlsInstallCACmd returns the "tls install-ca" cobra command.
...
// TlsShowCACmd returns the "tls show-ca" cobra command.
